...
def create_config_space():
	...
	learning_rate = CS.CategoricalHyperparameter("learning_rate",['Exponential_Decay', 'Step_Decay'], default_value='Exponential_DecayDecay')
	...
	Step_Decay_epochs_per_step = CS.UniformIntegerHyperparameter("Step_Decay_epochs_per_step",
                                                   ...
                                                   upper=128,
												   log=True)
    cs.add(Step_Decay_epochs_per_step)
